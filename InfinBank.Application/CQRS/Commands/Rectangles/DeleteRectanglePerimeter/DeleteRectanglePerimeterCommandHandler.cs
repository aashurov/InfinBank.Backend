...
public class DeleteRectanglePerimeterCommandHandler : IRequestHandler<DeleteRectanglePerimeterCommand>
{
    ...
    public DeleteRectanglePerimeterCommandHandler(IInfinBankDBContext dbContext, ICustomLoggingBehavoir customLoggingBehavior) => (_dbContext, _customLoggingBehavior) = (dbContext, customLoggingBehavior);

    public async Task<Unit> Handle(DeleteRectanglePerimeterCommand request, CancellationToken cancellationToken)
    {
